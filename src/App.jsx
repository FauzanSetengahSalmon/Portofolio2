  ...
  return (
    <>
        ...
        <div className="animate__animated animate__fadeInUp animate__delay-2s space-y-6 text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start gap-3 bg-zinc-800 w-fit mx-auto md:mx-0 p-4 rounded-2xl shadow-md">
            ...
            <q className="text-white text-sm">
              Aku bisa menyusun ribuan baris kode… tapi tak bisa merangkai cara melupakanmu.
            </q>
          </div>
      ...
      <div className="tentang mt-32 py-10" id="tentang">
        <div className="xl:w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-800 rounded-lg" data-aos="fade-up" data-aos-duration="1000" data-aos-once="200">
          <img
            src={DataImage.HeroImage}
            alt="Image"
        ...
        <div className="tools mt-32">
          <h1 className="text-4xl/snug font-bold mb-4 text-center" data-aos="fade-up" data-aos-duration="1000">Tools yang dipakai</h1>
          <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50 text-center mx-auto" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
      ...
      <div className="proyek mt-32 py-10" id="proyek">
        <h1 className="text-center text-4xl font-bold mb-2" data-aos="fade-up" data-aos-duration="1000">Proyek Web</h1>
        <p className="text-base/loose text-center opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        ...
        <p className="text-base/loose text-center mb-10 opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
          Mari terhubung dengan saya.
        </p>
        <form
          action="https://formsubmit.co/ahmadfauzan201006@gmail.com" method="POST"
          className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md"
          autoComplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400"
        >
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows="7"
                placeholder="Pesan..."
                className="border border-zinc-600 p-2 rounded-md" required
              ></textarea>
            </div>
            <div className="text-center">
              <button  className="bg-violet-700 p-3 rounded-lg w-full cursor-pointer block border border-zinc-600 hover:bg-violet-600" type="submit">Kirim Pesan</button>
            </div>
          </div>
        </form>
      </div>
